...
int main () {
    ...
    TimeBlock dailyRepeatingBlock = {startTime, endTime, {RepeatType::Daily, 100}};
    ...
    TimeBlock busy_time_test = {start_time_test, end_time_test, {RepeatType::NoRepeat, 0}};
    ...
    TimeBlock busy_time_test_2 = {start_time_test_2, end_time_test_2, {RepeatType::NoRepeat,0}};
    ...
    // std::vector<TimeBlock> busy_times_on_day = my_cal.get_busy_times_in_day(day_to_test);

    TimeAndDate start_to_test = TimeAndDate::build(480,1,2024);
    TimeAndDate end_to_test = TimeAndDate::build(0,2,2024);

    // std::vector<TimeBlock> busy_times_in_range = my_cal.get_busy_times_in_range(start_to_test,end_to_test );
